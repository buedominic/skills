...
| 03 | `03-context-kit-skills.md` | `projekt-setup` + `kontext-audit` | B, C, F |
...
Gate-2-Approval-Passus, „Keine erfundenen Beweise", „Keine PII/Secrets",
die `.env`-Verbote. Phase 01 macht genau das prüfbar, bevor Phase 02 beginnt.
